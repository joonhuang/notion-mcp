...
export const updateBlock = async (blockId: string, properties: any) => {
...
export const appendBlockChildren = async (blockId: string, children: any[]) => {
...
export function registerToolsForBlock(server: McpServer) {
    server.tool(
        "get-notion-block",
        { blockId: z.string() },
        async ({ blockId }) => {
    ...
    server.tool(
        "update-notion-block",
        { blockId: z.string(), properties: z.any() },
        async ({ blockId, properties }) => {
    ...
    server.tool(
        ...
        { blockId: z.string(), children: z.array(z.any()) },
